                ...
                <div className="aboutcontainer" style={{minHeight:'70vh',width:'100%',display:"flex",position:'relative',alignItems:'center' }}>
                    <div className="right" style={ {minWidth:'40%',}}>
                        <div className="imgbox" style={{ display:"flex",justifyContent:'center',alignItems:"center",padding:'2vw'}}>
                          ...
                          <img className="aboutimg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdye7L3ilAu-zsPozLZcZeE9PEg9WLBka4hg&s" alt=""  style={{maxHeight:'50vh',width:'380px',backgroundColor:'red',objectFit:"cover",objectPosition:'center',borderRadius:'25px' ,zIndex:'8', position:'absolute'}} />
                          <img className="aboutimg" src="https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZmVtYWxlJTIwcG9ydHJhaXR8ZW58MHx8MHx8fDA%3D" alt=""  style={{maxHeight:'50vh',width:'380px',backgroundColor:'red',objectFit:"cover",objectPosition:'center',borderRadius:'25px' ,zIndex:'7', position:'absolute'}} />
                          <img className="aboutimg" src="https://upload.wikimedia.org/wikipedia/commons/1/1e/Outdoors-man-portrait.jpg" alt=""  style={{maxHeight:'50vh',width:'380px',backgroundColor:'red',objectFit:"cover",objectPosition:'center',borderRadius:'25px' ,zIndex:'6', position:'absolute'}} />
                          <img className="aboutimg" src="https://images.unsplash.com/photo-1595152452543-e5fc28ebc2b8?q=80&w=1000&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8bWVuJTIwcG9ydHJhaXR8ZW58MHx8MHx8fDA%3D" alt=""  style={{maxHeight:'50vh',width:'380px',backgroundColor:'red',objectFit:"cover",objectPosition:'center',borderRadius:'25px' ,zIndex:'5', position:'absolute'}} />
                          <img src="https://expertphotography.b-cdn.net/wp-content/uploads/2019/04/female-face-girl-with-wind-in-hair.jpg" alt=""  style={{maxHeight:'50vh',width:'380px',backgroundColor:'red',objectFit:"cover",objectPosition:'center',borderRadius:'25px' ,zIndex:'4', position:'absolute'}} />
                        </div> 
                    </div>         
