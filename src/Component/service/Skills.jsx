    ...
    return(
        ...
        <div className="skillpage" style={{minHeight:'220vh',width:'100%' ,backgroundColor:'rgb(231, 247, 240)'}}>
            ...
            <div className="servicebox" style={{minHeight:'60vh',width:'100%',padding:'0 5vw 5vw 5vw',display:"flex",flexDirection:'column',alignItems:"center",justifyContent:'center'}}>
                ...
                <img className="skillcircle" src="https://static.jobscan.co/blog/uploads/Skills-for-resume-1.jpg" alt="" style={{height:'370px',top:'9vh' ,position:'relative',maxWidth:'370px',objectFit:'cover',objectPosition:'center',borderRadius:'50%'   }} />
                <div className="boxcontainer" style={{height:'34vh' ,maxWidth:'100%',position:'relative',display:'flex',justifyContent:'center',gap:'2vw'}}>
                <div className="box" style={{minHeight:'40vh' ,padding:'2vw' ,overflow:"hidden",display:'flex',flexDirection:'column',alignItems:'center',minWidth:'28vw',backgroundColor:'rgba(193, 241, 228, 0.6)'}}>
                    ...
                    <h2 style={{fontSize:'2rem',margin:'1vw',textAlign:'center',color:'rgb(42, 111, 82)'}}>Web Designing</h2>
                    <p style={{fontSize:'1.1rem',textAlign:'center',width:'28vw'}}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum, debitis?Lorem ipsum dolor sit, amet consectetur adipisicing elit. Repellendus ea esse sint asperiores unde ullam.</p>
                </div>
                <div className="box" style={{minHeight:'40vh',padding:'2vw'  ,overflow:"hidden",display:'flex',flexDirection:'column',alignItems:'center',minWidth:'28vw',backgroundColor:'rgba(193, 241, 228, 0.6)'}}>
            ...
            <div className="skillsection" style={{height:'80vh',width:'100%',padding:'5vw 10vw',display:'flex',flexDirection:'column',alignItems:'center'}}>
                <div className="langbox" style={{height:'10vh',minWidth:'80%',display:'flex',flexDirection:'column',justifyContent:'space-between',padding:'0.8vw 2vw'}} >
